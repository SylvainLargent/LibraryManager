  ...
  <body>
    ...
    <main>
      <section class="content">
        ...
        <div class="row">
          <div class="container">
            <h5>Suppression du livre numero ${livre.primaryKey}</h5>
            <!-- TODO : afficher l'id du livre au lieu de 42 -->
            <div class="row">
              <p>�tes-vous s�r de vouloir supprimer le livre ${livre.titre} de ${livre.auteur} (code ${livre.isbn}) ?
              </p>
              <!-- TODO : compl�ter les trois informations ci-contre -->
              <form action="/TP3Ensta/livre_delete" method="post" class="col s12">
                <input type="hidden" value="${livre.primaryKey}" name="id">
                ...
                <div class="row center">
                  ...
                  <a class="btn waves-effect waves-light orange"
                    href="/TP3Ensta/livre_details?id=${livre.primaryKey}">Annuler</a>
                  <!-- TODO : remplacer idDuLivre par l'id du livre -->
                </div>
              </form>
            </div>
