	...
	<body>
		...
		<main>
			<section class="content">
				...
				<div class="row">
					<div class="container">
						<h5>D�tails du membre numero ${membre.primaryKey}</h5>
						<!-- TODO : remplacer 007 par l'id du membre -->
						<div class="row">
							<form action="/TP3Ensta/membre_details?id=${membre.primaryKey}" method="post"
								class="col s12">
								...
								<div class="row">
									...
									<div class="input-field col s4">
										<select name="abonnement" class="browser-default">
											<!-- TODO : faire en sorte que l'option correspondant à l'abonnement du membre soit s�lectionn�e par d�faut -->
							...
							<form action="/TP3Ensta/membre_delete" method="get" class="col s12">
								<input type="hidden" value="${membre.primaryKey}" name="id">
								<!-- TODO : remplacer idDuMembre par l'id du membre -->
								<div class="row center">
								...
								<table class="striped">
									...
									<tbody id="results">
										<c:forEach items="${listEmprunt}" var="emprunt" varStatus="loop">
											<tr>
												<td>${listLivre[loop.count - 1].titre} de ${listLivre[loop.count -
													1].auteur}</td>
												...
												<c:choose>
													...
													<c:otherwise>
														<td>
															<a href="emprunt_return?id=${emprunt.primaryKey}">
