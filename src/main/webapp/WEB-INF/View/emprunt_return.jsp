  ...
  <body>
    ...
    <main>
      <section class="content">
        ...
        <div class="row">
          <div class="container">
            <h5>Sélectionnez le livre a retourner</h5>
            <div class="row">
                  ...
                  <div class="input-field col s12">
                    <select id="id" name="id" class="browser-default">
                      ...
                      <c:forEach items="${listEmprunt}" var="emprunt" varStatus="loop">
                        <tr>
                          <option value="${emprunt.primaryKey}">
                            ${listLivre[loop.count - 1].titre}, emprunté
                            par
                            ${listMembre[loop.count - 1].prenom} ${listMembre[loop.count - 1].nom}</option>
                        </tr>
                      </c:forEach>
                      <c:if test="${empruntDefault != 0}">
                        <option value="${empruntDefault}" ${(emprunDefault !="0" ) ? " selected" : "" }>
                          ${livreDefault.titre}, emprunté
                          par
                          ${membreDefault.prenom} ${membreDefault.nom}</option>
                      </c:if>
